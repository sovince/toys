...
class EncryptDiscuz
{
    ...
    public function __construct($key='your key')
    {
        $this->key = $key;
    }
     ...
     * @return string
     */
    public function encode($str,$expiry = 0){
     ...
     * @return string
     */
    public function decode($code,$expiry = 0){
        return $this->authcode($code,'DECODE',$expiry);
    }
     ...
     * @return string
     */
    private function authcode ($string, $operation = 'DECODE', $expiry = 0)
    {
        $ckey_length = 4;
